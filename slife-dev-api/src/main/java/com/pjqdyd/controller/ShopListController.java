 ...
 */
@Slf4j
@Api(value = "店铺列表相关接口", tags = "店铺列表Controller层")
@CrossOrigin
@RestController
...
public class ShopListController {
     ...
     * @return 包含
     */
    @ApiOperation(value = "分页查询附近的商铺", tags = "主页查询附近商铺")
     ...
     * @return
     */
    @ApiOperation(value = "查询附近所有的商铺", tags = "查询附近所有商铺")
    @GetMapping("/allLocalShop")
    public ResponseResult getAllLocalShopList(@RequestParam("latitude") Double latitude,
                                              @RequestParam("longitude") Double longitude){
        //查询附近的所有店铺
        List<Shop> shopList = shopListService.findAllLocaly(latitude, longitude, 1);
